...
const Signup = () => {
    ...
    const [payement_aggrement, setPayementAgreement] = useState("");   
            ...
            <section >
                < div className='container signup_container'>
                    ...
                    <form onSubmit={handleSubmit} >{/* add post action & on sucessful posting, redirect to join community page (write a function) */}
                        ...
                        <select name="payment agreement" id="payment agreement" onChange={(e) => setPayementAgreement(e.target.value)} required>
                            <option value=" " disabled selected hidden>Please Select</option>
                            <option value=" Yes">Yes</option>
                            <option value=" No">No</option>
                        </select>
                        <div ><input type="checkbox" id="checkbox" name="" onChange={(e) => setOneOnOneMentorship(e.target.value)} required></input>
